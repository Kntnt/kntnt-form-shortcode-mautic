                    ...
                    <td>
						<?php switch ( $field['type'] ):
							...
							<?php case 'text group': ?>
								...
								<?php break; ?>
                            <?php case 'password': ?>
                                <input id="<?php echo $id ?>" type="password" name="<?php echo "{$ns}[$id]" ?>" value="<?php echo $values[ $id ]; ?>" size="<?php echo isset( $field['size'] ) ? $field['size'] : 20; ?>" <?php echo isset( $field['disabled'] ) && $field['disabled'] ? 'disabled' : ''; ?> <?php echo isset( $field['required'] ) && $field['required'] ? 'required' : ''; ?> <?php echo isset( $field['disabled'] ) && $field['disabled'] ? 'disabled' : ''; ?>>
                                <br>
                                <?php break; ?>
							<?php case 'integer': ?>
							<?php case 'number': ?>
							...
							<?php case 'checkbox group': ?>
                                <fieldset id="<?php echo $id ?>">
									<?php foreach ( $field['options'] as $value => $item ): ?>
                                        <input type="checkbox" name="<?php echo "{$ns}[$id][$value]" ?>" value="<?php echo $value; ?>" <?php echo isset( $field['disabled'] ) && $field['disabled'] ? 'disabled' : ''; ?> <?php echo in_array( $value, $values[ $id ] ) ? 'checked' : '' ?> <?php echo isset( $field['required'] ) && $field['required'] ? 'required' : ''; ?> <?php echo isset( $field['disabled'] ) && $field['disabled'] ? 'disabled' : ''; ?>> <?php echo $item; ?><br>
                                        <br>
									<?php endforeach; ?>
                                </fieldset>
								<?php break; ?>
